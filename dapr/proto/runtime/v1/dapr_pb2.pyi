...
class BulkPublishRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        pubsub_name: typing.Text = ...,
        topic: typing.Text = ...,
        entries: typing.Optional[typing.Iterable[global___BulkPublishRequestEntry]] = ...,
        metadata: typing.Optional[typing.Mapping[typing.Text, typing.Text]] = ...,
        ) -> None: ...
...
class BulkPublishResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        failedEntries: typing.Optional[typing.Iterable[global___BulkPublishResponseFailedEntry]] = ...,
        ) -> None: ...
...
class GetMetadataResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        subscriptions: typing.Optional[typing.Iterable[global___PubsubSubscription]] = ...,
        ) -> None: ...
...
class PubsubSubscription(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        topic: typing.Text = ...,
        metadata: typing.Optional[typing.Mapping[typing.Text, typing.Text]] = ...,
        rules: typing.Optional[global___PubsubSubscriptionRules] = ...,
        dead_letter_topic: typing.Text = ...,
        ) -> None: ...
...
class PubsubSubscriptionRules(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        rules: typing.Optional[typing.Iterable[global___PubsubSubscriptionRule]] = ...,
        ) -> None: ...
...
class GetWorkflowRequest(google.protobuf.message.Message):
    ...
    workflow_component: typing.Text
    def __init__(self,
        *,
        instance_id: typing.Text = ...,
        workflow_type: typing.Text = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["instance_id",b"instance_id","workflow_component",b"workflow_component","workflow_type",b"workflow_type"]) -> None: ...
...
class StartWorkflowRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        input: typing.Optional[google.protobuf.any_pb2.Any] = ...,
        ) -> None: ...
...
class TerminateWorkflowResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    def __init__(self,
        ) -> None: ...
global___TerminateWorkflowResponse = TerminateWorkflowResponse
